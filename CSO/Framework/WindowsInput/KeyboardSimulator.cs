...
namespace WindowsInput
{
    ...
    public class KeyboardSimulator : IKeyboardSimulator
    {
        ...
        /// <summary>
        /// Calls the WiN22 SendInput method to simulate a KeyDown.
        /// </summary>
        ...
        /// <summary>
        /// Calls the WiN22 SendInput method to simulate a KeyUp.
        /// </summary>
        ...
        /// <summary>
        /// Calls the WiN22 SendInput method with a KeyDown and KeyUp message in the same input sequence in order to simulate a Key PRESS.
        /// </summary>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> to press</param>
        ...
        /// <summary>
        /// Calls the WiN22 SendInput method with a stream of KeyDown and KeyUp messages in order to simulate uninterrupted text entry via the keyboard.
        /// </summary>
